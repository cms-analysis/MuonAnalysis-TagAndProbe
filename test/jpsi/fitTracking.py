...
if scenario.startswith("data"):
    if scenario == "data_all":
        ...
        process.TnP_Tracking.binsForMassPlots = cms.uint32(23)
         ...
         process.TnP_Tracking.InputFileNames = [ "tnpJPsi_JPsiMuMu_Spring10_0.117pb.root", "tnpJPsi_ppMuX_Spring10_0.117pb.root" ]
    ...
    for X in ("", "NoJPsi", "NoBestJPsi"):
        setattr(process.TnP_Tracking.Efficiencies, "eff"+X, cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("passing"+X,"pass"),
            UnbinnedVariables = cms.vstring("mass"),
        ...
        setattr(process.TnP_Tracking.Efficiencies, "eff_eta"+X, cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("passing"+X,"pass"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
                pt  = cms.vdouble(0,15),
        ...
        setattr(process.TnP_Tracking.Efficiencies, "eff_pt_eta"+X, cms.PSet(
            EfficiencyCategoryAndState = cms.vstring("passing"+X,"pass"),
            UnbinnedVariables = cms.vstring("mass"),
            BinnedVariables = cms.PSet(
                pt  = cms.vdouble(0, 3.0, 5.0, 15.0),
                abseta       = cms.vdouble(0, 1.1, 2.5),
                tag_Mu3      = cms.vstring("pass"),
                hasValidHits = cms.vstring("pass"),
            ),
            BinToPDFmap = cms.vstring(sampleToPdfMap[X])
