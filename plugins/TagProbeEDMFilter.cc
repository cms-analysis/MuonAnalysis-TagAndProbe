...
// 
/**\class TagProbeEdmFilter TagProbeEdmFilter.cc MuonAnalysis/TagProbeEdmFilter/src/TagProbeEdmFilter.cc
...
// Include files
#include "MuonAnalysis/TagAndProbe/interface/TagProbeEDMFilter.h"
